...
class LifetimeAllowanceExceededErrorControllerSpec extends BaseSpec {
 ...
 "LifetimeAllowanceExceededErrorController" should {
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment when more than 7 years from " +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededError Controlller for first investment when more than 10 years from " +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment when NOT more than 7 years from " +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment when EXACTLY 7 years from " +
    "Commercial sale date when not deemed knowledge intensive with subsidiaries and not exceeded lifetime limit" should {
    "redirect to new subsidiaries-spending-investment page" in {
      when(mockS4lConnector.fetchAndGetFormData[KiProcessingModel](Matchers.eq(KeystoreKeys.kiProcessingModel))(Matchers.any(), Matchers.any(), Matchers.any()))
        .thenReturn(Future.successful(Option(falseKIModel)))
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment when NOT more than 10 years from " +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment when EXACTLY 10 years from " +
    "Commercial sale date when it is deemed knowledge intensive with subsidiaries and not exceeded lifetime limit" should {
    "redirect to new subsidiaries-spending-investment page" in {
      when(mockS4lConnector.fetchAndGetFormData[KiProcessingModel](Matchers.eq(KeystoreKeys.kiProcessingModel))(Matchers.any(), Matchers.any(), Matchers.any()))
        .thenReturn(Future.successful(Option(trueKIModel)))
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment is NOT more than 7 years from " +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment is EXACTLY 7 years from " +
    "Commercial sale date when it is NOT deemed knowledge intensive and without any subsidiaries and not exceeded lifetime limit" should {
    "redirect to new how-plan-to-use-investment page" in {
      when(mockS4lConnector.fetchAndGetFormData[KiProcessingModel](Matchers.eq(KeystoreKeys.kiProcessingModel))(Matchers.any(), Matchers.any(), Matchers.any()))
        .thenReturn(Future.successful(Option(falseKIModel)))
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for the first investment when NOT more than 10 years from " +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for the first investment when EXACTLY 10 years from " +
    "Commercial sale date and when it IS deemed knowledge intensive and without any subsidiaries and not exceeded lifetime limit" should {
    "redirect to new how-plan-to-use-investment page" in {
      when(mockS4lConnector.fetchAndGetFormData[KiProcessingModel](Matchers.eq(KeystoreKeys.kiProcessingModel))(Matchers.any(), Matchers.any(), Matchers.any()))
        .thenReturn(Future.successful(Option(trueKIModel)))
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for the first investment when no commercial sale has been made " +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController when investment has been used previously and a commercial sale exists" +
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for first investment with empty PrevRFI and not exceeded lifetime limit" should {
  ...
  "Sending a valid form submit to the LifetimeAllowanceExceededErrorController for the first investment with an empty KIProcessingModel " +
    "and not exceeded lifetime limit" should {
