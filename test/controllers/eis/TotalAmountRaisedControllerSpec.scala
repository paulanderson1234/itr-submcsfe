...
class TotalAmountRaisedControllerSpec extends BaseSpec {
  ...
  "Sending a valid form submit to the TotalAmountRaisedController for first investment with " +
    "empty HadOtherInvestments and not exceeded lifetime limit" should {
