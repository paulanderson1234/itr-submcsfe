...
import controllers.eis.DeleteInvestorController
import models.investorDetails.{InvestorDetailsModel, PreviousShareHoldingModel}
import org.jsoup.Jsoup
import play.api.i18n.Messages
import play.api.i18n.Messages.Implicits._
import views.html.eis.investors.DeleteInvestor
...
class DeleteInvestorSpec  extends BaseSpec {
  ...
  "The delete investor page" should {
    ...
    "contain the correct elements for an investor (individual)" in {
      ...
      document.body.getElementById("delete-investor-cancel").attr("href") shouldEqual controllers.eis.routes.ReviewAllInvestorsController.show().url
    }
