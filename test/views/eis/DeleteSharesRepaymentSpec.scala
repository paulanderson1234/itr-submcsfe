...
import controllers.eis.{routes, DeleteInvestorController}
import models.investorDetails.{InvestorDetailsModel, PreviousShareHoldingModel}
import org.jsoup.Jsoup
import play.api.i18n.Messages
import play.api.i18n.Messages.Implicits._
import views.html.eis.investors.{DeleteSharesRepayment, DeleteInvestor}
...
class DeleteSharesRepaymentSpec  extends BaseSpec {
  ...
  "The Delete Shares Repayment page" should {
    ...
    "contain the correct elements when a valid share repayment is passed to the view" in {
      ...
      document.body.getElementById("delete-investor-cancel").attr("href") shouldEqual routes.ReviewPreviousRepaymentsController.show().url
    }
