...
class ResearchStartDateErrorSpec extends ViewSpec {
 
  "The ResearchStartDateError page" should {
    "contain the expected elements" in {
      val page = ResearchStartDateError()(fakeRequest, applicationMessages)
      val document = Jsoup.parse(page.body)

      document.title shouldEqual Messages("page.companyDetails.ResearchStartDateError.title")
