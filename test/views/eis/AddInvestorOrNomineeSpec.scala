...
class AddInvestorOrNomineeSpec extends ViewSpec {
  ...
  "AddInvestorOrNominee view" should {
    ...
    "Verify that page contains the correct elements when a valid model is passed from keystore with alternate url" in new Setup {
      val document: Document = {
    ...
    "Verify that the page page contains the correct elements when an invalid models is passed" in new Setup {
      val document: Document = {
