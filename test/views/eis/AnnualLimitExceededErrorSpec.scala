...
class AnnualLimitExceededErrorSpec extends ViewSpec {
 
  "The AnnualLimitExceededError page" should {
    "contain the expected elements" in {
      val page = AnnualLimitExceededError()(fakeRequest, applicationMessages)
      ...
      document.body.getElementById("warning-description").text() shouldEqual Messages("page.AnnualLimitExceededWarning.description")
