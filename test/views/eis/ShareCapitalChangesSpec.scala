...
import controllers.eis.{ShareCapitalChangesController, routes}
...
class ShareCapitalChangesSpec extends ViewSpec {
  ...
  "The Is this the first trade your company has carried out page" should {
    ...
    "Verify that the page contains the correct elements when a valid model is passed from keystore with expected url" in new Setup {
    ...
    "Verify that the page contains the correct elements when a valid IsFirstTRadeModel is passed from keystore with alternate url" in new Setup {
      val document: Document = {
    ...
    "Verify that the page page contains the correct elements when an invalid ShareCapitalChangesModel is passed" in new Setup {
      val document: Document = {
