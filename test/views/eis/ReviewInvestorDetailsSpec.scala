...
class ReviewInvestorDetailsSpec extends ViewSpec {
  ...
  "The Review Investor Details page" when {
    ...
    "provided with an unfinished model for a nominee" should {
      lazy val view = views.html.eis.investors.ReviewInvestorDetails(InvestorDetailsModel(Some(AddInvestorOrNomineeModel(
      ...
      "have a table for investor details" which {
        ...
        "has an entry for investor or nominee" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe
              controllers.eis.routes.ReviewInvestorDetailsController.change(Constants.AddInvestorOrNomineeController, 1).url
          }
        }
        ...
        "has an entry for company or individual" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe
              controllers.eis.routes.ReviewInvestorDetailsController.change(Constants.CompanyOrIndividualController, 1).url
          }
        }
        ...
        "has an entry for number of shares purchased" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe
              controllers.eis.routes.ReviewInvestorDetailsController.change(Constants.NumberOfSharesPurchasedController, 1).url
          }
        }
        ...
        "has an entry for amount spent" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe
              controllers.eis.routes.ReviewInvestorDetailsController.change(Constants.HowMuchSpentOnSharesController, 1).url
          }
        }
      }
      ...
      "have a table for shareholding details" which {
        ...
        "has an entry for previous shareholdings" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe
              controllers.eis.routes.ReviewInvestorDetailsController.change(Constants.IsExistingShareHolderController, 1).url
          }
        }
    ...
    "provided with a completed model for an investor who is a company" should {
      lazy val view = views.html.eis.investors.ReviewInvestorDetails(testModel)
      lazy val doc = Jsoup.parse(view.body)
      ...
      "have a table for investor details" which {
        ...
        "has an entry for company name" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe
              controllers.eis.routes.ReviewInvestorDetailsController.change(Constants.CompanyDetailsController, 1).url
          }
        }
      ...
      "have a table for shareholding details" which {
        ...
        "has a previous shareholding with an id of 1" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe controllers.eis.routes.PreviousShareHoldingsReviewController.show(1).url
          }
        }
        ...
        "has an add another shareholding link" which {
          ...
          "has a link to the shareholder description page" in {
            link.attr("href") shouldBe controllers.eis.routes.PreviousShareHoldingDescriptionController.show(1).url
          }
        }
      }
      ...
      "have a save and continue button" which {
        ...
        "links to the review investors page" in {
          button.attr("href") shouldBe controllers.eis.routes.ReviewAllInvestorsController.show().url
        }
      }
    }

    "provided with a model for an individual with an unfinished shareholding" should {
      lazy val view = views.html.eis.investors.ReviewInvestorDetails(testModel.copy(
      ...
      "have a table for investor details" which {
        ...
        "has an entry for individual name" which {
          ...
          "has a change link to the correct page" in {
            table.select(s"$id-change a").attr("href") shouldBe
              controllers.eis.routes.ReviewInvestorDetailsController.change(Constants.IndividualDetailsController, 1).url
          }
        }
