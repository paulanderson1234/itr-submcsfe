...
class ConfirmContactDetailsSpec extends UnitSpec with OneAppPerSuite{
  ...
  "The Confirm Contact Details page" should {
    ...
    "have a back-link" which {
      s"has the text '${Messages("common.section.progress.company.details.five")}" in {
      ...
      s"has a Section heading next to it of '${Messages("common.section.progress.company.details.five")}" in {
