...
import controllers.seis.{QualifyBusinessActivityController, routes}
...
class QualifyBusinessActivitySpec extends ViewSpec {
  ...
  "The Qualify Business Activity page" should {
    ...
    "Verify that the Qualifying Business Activity page contains the correct elements when an invalid QualifyingBusinessActivity is passed" in new SEISSetup {
      val document: Document = {
        setupMocks()
