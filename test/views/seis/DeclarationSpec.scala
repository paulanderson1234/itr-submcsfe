...
import controllers.seis.{DeclarationController, routes}
...
class DeclarationSpec extends ViewSpec {
  ...
  "The Declaration page" should {
    ...
    "Verify that the declaration page has the correct elements" in new SEISSetup {
      ...
      document.select("form").attr("action") shouldBe controllers.seis.routes.AcknowledgementController.show().url
