...
import views.html.eisseis.supportingDocuments.SupportingDocumentsUpload
...
class SupportingDocumentsUploadSpec extends ViewSpec {
  ...
  "The Supporting documents upload page" should {
    ...
    lazy val page = SupportingDocumentsUpload(form, controllers.eisseis.routes.ConfirmCorrespondAddressController.show().url)(fakeRequest, applicationMessages)
    lazy val emptyPage = SupportingDocumentsUpload(emptyForm, controllers.eisseis.routes.ConfirmCorrespondAddressController.show().url)(fakeRequest, applicationMessages)
    ...
    "contain the correct elements when a valid form is submitted" in new Setup {
      ...
      document.body.getElementById("back-link").attr("href") shouldEqual controllers.eisseis.routes.ConfirmCorrespondAddressController.show().url
