...
import views.html.eisseis.contactInformation._
...
class ConfirmContactDetailsSpec extends UnitSpec with OneAppPerSuite{
  ...
  "The Confirm Contact Details page" should {
    ...
    "have a back-link" which {
      ...
      s"has a link to '${controllers.eisseis.routes.ContactDetailsController.show().url}" in {
        document.body.getElementById("back-link").attr("href") shouldEqual controllers.eisseis.routes.InvestmentGrowController.show().url
      }
