...
object ShareIssueDateForm {

  val shareIssueDateForm = Form(
    mapping(
      "shareIssueDay" -> optional(number),
      "shareIssueMonth" -> optional(number),
      "shareIssueYear" -> optional(number)
    )(ShareIssueDateModel.apply)(ShareIssueDateModel.unapply)
