...
import views.html.eis.investors.NumberOfPreviouslyIssuedShares
...
trait NumberOfPreviouslyIssuedSharesController extends FrontendController with AuthorisedAndEnrolledForTAVC with ControllerHelpers {
  ...
  Action[AnyContent] = AuthorisedAndEnrolled.async { implicit user =>
    implicit request =>
