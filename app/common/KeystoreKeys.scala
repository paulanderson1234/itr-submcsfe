...
trait KeystoreKeys {
  ...
  val previousShareHoldingDescription: String = "previousShareHoldingDescription"
  ...
  val backLinkPreviousShareHoldingDescription: String = "backLink:PreviousShareHoldingDescription"
