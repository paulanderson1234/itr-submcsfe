...
object FrontendAppConfig extends AppConfig with ServicesConfig {
  ...
  override lazy val attachmentFileUploadUrl: (String)=> String = schemeType => {
    s"$attachmentsFrontEndServiceBaseUrl/file-upload?continueUrl=${submissionFrontendServiceBaseUrl}" +
      s"investment-tax-relief-cs/$schemeType/check-your-answers&backUrl=${submissionFrontendServiceBaseUrl}investment-tax-relief-cs/$schemeType/supporting-documents-upload"
  }
  ...
  val attachmentFileUploadOutsideUrl =
    s"$attachmentsFrontEndServiceBaseUrl/file-upload?continueUrl=${submissionFrontendServiceBaseUrl}investment-tax-relief-cs" +
      s"/check-your-documents&backUrl=${submissionFrontendServiceBaseUrl}investment-tax-relief-cs/supporting-documents-upload"
}
